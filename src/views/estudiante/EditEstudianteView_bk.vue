      ...
      <div class="card">
        ...
        <div class="card-body">
          <form @submit="guardar">
            ...
            <div class="input-group mb-3">   
              <input type="text" v-model="direccion" id="direccion" class="form-control" maxlength="100" placeholder="Direccion" >
            ...
            <div class="input-group mb-3"> 
              ...
              <select class="form-select text-center" @change="onChange($event)" id="depa_nacimiento"  v-model="depa_nacimiento">              
            ...
            <div class="input-group mb-3"> 
              ...
              <input type="text" v-model="tipo_ingreso" id="tipo_ingreso" class="form-control" maxlength="55" placeholder="Tipo Ingreso" >
            </div>
            <!-- AÑADIDOS -->
            ...
            <div class="input-group mb-3">                 
              ...
              <input type="text" v-model="idioma_regular" id="idioma_regular" class="form-control" maxlength="100" placeholder="Idioma Regular" >
            </div>
            ...
            <div class="input-group mb-3">   
              <input type="text" v-model="numero_registro" id="numero_registro" class="form-control" maxlength="100" placeholder="Numero de Registro" >
            </div>
            ...
            <div class="input-group mb-3">   
              <input type="number" v-model="numero_archivo" id="numero_archivo" class="form-control" maxlength="100" placeholder="Numero de Archivo" >
            </div>            
